...
@section('page_header')
    <div class="container-fluid">
        ...
        @can('delete', app($dataType->model_name))
            @include('vendor.voyager.users.partials.bulk-delete')
        @endcan
...
@section('content')
    @php
        $userEnableContent = $dataTypeContent->reject(function ($user) {
            return $user->status !== 'enable';
        });
        $countUserEnableContent = $userEnableContent->count();
        $userDisableContent = $dataTypeContent->reject(function ($user) {
