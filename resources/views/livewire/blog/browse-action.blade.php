<div class="flex space-x-1 justify-around">
    {{-- <a href="{{ route('blog.show', [$slug]) }}" target="_blank" class="p-1 text-teal-600 hover:bg-teal-600 hover:text-white rounded">
    ...
    <a href="{{ route('blog.edit', [$slug]) }}" target="_blank" class="p-1 text-blue-600 hover:bg-blue-600 hover:text-white rounded">
