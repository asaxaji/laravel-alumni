...
Route::group(['prefix' => 'web-admin', 'as' => 'voyager.'], function () {
    event(new Routing());
    ...
    Route::post('/users/account-accept/{user}', [UserController::class, 'acceptUser'])->name('user.confirm');
    Route::post('/users/account-decline/{user}', [UserController::class, 'declineUser'])->name('user.decline');
});